...
// Code Here
let setGroceryListTitle = x => `${yourName}'s Grocery List`;
//////////////////STEP 4////////////////////
...
// Code Here
let checkGroceryCount = x => {
	let totalLength = groceries.length;
	if (totalLength === 1) {
		return "1 Item";
	} else if (totalLength > 5) {
		return "That looks like a big trip";
	} else if (totalLength > 1 && totalLength < 5) {
		return `${totalLength} items`;
	}
};
