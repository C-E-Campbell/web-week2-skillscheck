...
//Code here
let lovesCodeChecker = x => (x ? true : false);
...
colorCopy.push("blazing hot pink");
...
// Code Here
let myNumbersIndex = [];
myNumbers.forEach((element, i, arr) => myNumbersIndex.push(i));
//////////////////PROBLEM 18////////////////////

// Did you know that George Foreman has five sons named George?
//Let's go ahead and change everyone's name in the notGeorge array to George using .map.
